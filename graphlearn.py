...
class graphlearn():
    ...
    def add_placeholders(self):
        '''
        Add placeholders for graphlearn.
        '''
    ...
    def fit(self, sess):
        '''
        Start estimating graphlearn model.
    ...
    def __init__(self, args):
        '''
        Initialize graphlearn model with args.
...
if __name__=='__main__':
    parser = argparse.ArgumentParser(description='graphlearn')

    parser.add_argument('-file',        dest='filename',    default='output.kgfl.w100.l10.txt',    help='The random walks filename')
    ...
    parser.add_argument('-types',       dest='typestr',     default='l',  type=str, help='Specify types occurring in the data')
